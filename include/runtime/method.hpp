...
public:
//	Method(method_info *mi, cp_info **constant_pool) : constant_pool(constant_pool) {
	Method(InstanceKlass *klass, const ClassFile & cf) : klass(klass) {
		method_info *mi = cf.methods;
		cp_info **constant_pool = cf.constant_pool;
